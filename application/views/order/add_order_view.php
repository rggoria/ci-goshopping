...
<div class="d-flex align-items-center justify-content-center min-vh-100">
    ...
    <div class="card border-gray w-50">
        ...
        <!-- Card body -->
        <?= form_open('Order/add_cart/'.$product_id);?>
            <div class="card-body row">
                <div class="col-md-6 p-3 bg-dark text-white">
                    <img src="<?= base_url('uploads/images/'.$product_image);?>" class="card-img-top">                    
                </div>
            ...
            <div class="d-flex justify-content-around">
                <a class="btn btn-primary m-2" href="<?php echo site_url('Homepage/Category/'.$product_category) ?>" role="button">Go Back</a>
